...
test_span_gre_dir_acl()
{
	...
	test_span_gre_dir_ips "$tundev" 192.0.2.3 192.0.2.4 v$h1
}
...
rev_test_span_gre_dir_acl()
{
	...
	test_span_gre_dir_ips "$tundev" 192.0.2.4 192.0.2.3 v$h2
}
...
full_rev_test_span_gre_dir_acl()
{
	...
	rev_test_span_gre_dir_acl "$tundev"
	mirror_uninstall $swp1 $direction
...
test_gretap()
{
	full_test_span_gre_dir_acl gt4 192.0.2.4 "ACL mirror to gretap"
	full_rev_test_span_gre_dir_acl gt4 192.0.2.3 "ACL mirror to gretap"
}

test_ip6gretap()
{
	full_test_span_gre_dir_acl gt6 192.0.2.4 "ACL mirror to ip6gretap"
	full_rev_test_span_gre_dir_acl gt6 192.0.2.3 "ACL mirror to ip6gretap"
}
