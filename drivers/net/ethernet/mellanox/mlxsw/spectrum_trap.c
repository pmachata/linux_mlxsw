...
static const struct mlxsw_sp_trap_group_item mlxsw_sp_trap_group_items_arr[] = {
	...
	{
		.group = DEVLINK_TRAP_GROUP_GENERIC(L2_EXCEPTIONS, 1),
		.hw_group_id = MLXSW_REG_HTGT_TRAP_GROUP_SP_L2_EXCEPTIONS,
		.priority = 2,
	},
};
...
static const struct mlxsw_sp_trap_item mlxsw_sp_trap_items_arr[] = {
	...
	{
		.trap = MLXSW_SP_TRAP_EXCEPTION(FDB_MISS, L2_EXCEPTIONS),
		.listeners_arr = {
			MLXSW_SP_RXL_NO_MARK(FDB_MISS, L2_EXCEPTIONS,
					     TRAP_TO_CPU, false),
		},
	},
	{
		.trap = MLXSW_SP_TRAP_DROP(FDB_MISMATCH, L2_DROPS),
		.listeners_arr = {
