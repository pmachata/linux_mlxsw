...
static inline void mlxsw_reg_smid2_smpe_pack(char *payload, u16 mid, u16 port,
					     bool set, bool smpe_valid,
					     u16 smpe)
{
	mlxsw_reg_smid2_pack(payload, mid, port, set);
	if (smpe_valid) {
		mlxsw_reg_smid2_smpe_valid_set(payload, smpe_valid);
		mlxsw_reg_smid2_smpe_set(payload, smpe);
	}
}
...
enum mlxsw_reg_htgt_trap_group {
	...
	MLXSW_REG_HTGT_TRAP_GROUP_SP_L2_EXCEPTIONS,
