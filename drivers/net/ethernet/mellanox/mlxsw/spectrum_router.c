					   ...
					   unsigned long event, void *ptr)
{
	...
	if (mlxsw_sp_is_offload_xstats_event(event))
		return mlxsw_sp_netdevice_offload_xstats_cmd(mlxsw_sp, dev,
							     event, ptr);
	if (mlxsw_sp_netdev_is_ipip_ol(mlxsw_sp, dev))
		return mlxsw_sp_netdevice_ipip_ol_event(mlxsw_sp, dev,
							event, ptr);
	if (mlxsw_sp_netdev_is_ipip_ul(mlxsw_sp, dev))
		return mlxsw_sp_netdevice_ipip_ul_event(mlxsw_sp, dev,
							event, ptr);
	if (mlxsw_sp_is_router_event(event))
		return mlxsw_sp_netdevice_router_port_event(dev, event, ptr);
	if (mlxsw_sp_is_vrf_event(event, ptr))
		return mlxsw_sp_netdevice_vrf_event(dev, event, ptr);
