					     ...
					     unsigned long event, void *ptr)
{
	...
	case NETDEV_OFFLOAD_XSTATS_ENABLE:
		err = nsim_dev_hwsdev_enable(hwsdev);
		break;
...
int nsim_dev_hwstats_event(struct nsim_dev *nsim_dev, struct net_device *dev,
			   unsigned long event, void *ptr)
{
